      ...
      <div className="mt-6.5 grid grid-cols-1 gap-5.5 md:grid-cols-2">
        <div className="rounded-xl border border-[var(--plg-hair)] bg-[var(--plg-paper)] p-6">
          <h3 className="flex items-center gap-2.5 text-[17px] font-semibold text-[var(--plg-ink)]">
            <span className="h-2.5 w-2.5 flex-none rounded-full bg-[var(--plg-ink)]" /> Topic headlines
          </h3>
          ...
          <ul className="mt-3.5 list-none p-0">
            {best && (
              <li className="flex items-center justify-between gap-3.5 border-t border-[var(--plg-hair)] py-2.5 text-sm text-[var(--plg-text2)] first:border-t-0">
            ...
            <li className="flex items-center justify-between gap-3.5 border-t border-[var(--plg-hair)] py-2.5 text-sm text-[var(--plg-text2)]">
        ...
        <div className="rounded-xl border border-[var(--plg-hair)] bg-gradient-to-b from-[rgba(90,175,254,.10)] to-[var(--plg-paper)] p-6">
          <h3 className="flex items-center gap-2.5 text-[17px] font-semibold text-[var(--plg-ink)]">
            <span className="h-2.5 w-2.5 flex-none rounded-full bg-[var(--plg-accent)]" /> The read
          </h3>
